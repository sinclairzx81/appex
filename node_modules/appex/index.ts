...
/// <reference path="router/Route.ts" />
/// <reference path="runtime/HttpRuntime.ts" />
...
exports.HttpRuntime      = appex.HttpRuntime;

function prepare_options(options:appex.HttpRuntimeOptions) : appex.HttpRuntimeOptions {

    options.devmode == null ? false : options.devmode;

    return options;
}

export function runtime (options:appex.HttpRuntimeOptions) : (request:http.ServerRequest, response:http.ServerResponse, next:() => void) => void {
    
    options = prepare_options(options);

    var runtime = new appex.HttpRuntime( prepare_options (options) );

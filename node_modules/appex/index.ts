...
export function runtime (options:appex.IRuntimeOptions) : (request:http.ServerRequest, response:http.ServerResponse, next:() => void) => void {
...
//export function require(endpoint:string, callback:(module:any)=>void) : void {

//    // todo: implement a meta data lookup and return a proxy.

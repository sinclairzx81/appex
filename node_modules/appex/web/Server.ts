        ...
        public handler (request:http.ServerRequest, response:http.ServerResponse, next?:() => void) : void {
            ...
            this.compile((diagnostics) => {
                ...
                while(this.requests.length > 0) {
                    ...
                    var pending = this.requests.pop ();

                    var context = this.load_context(pending.request, pending.response);

                    var handled = this.router.handler (context, pending.request, pending.response, pending.next);

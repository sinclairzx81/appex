...
module appex.web {
    ...
    export class Server implements appex.web.IServer, appex.IDisposable {
        ...
        public listen(port:number) : void {
            ...
            this.server = node.http.createServer((request : http.ServerRequest, response : http.ServerResponse, next : Function) : void => {
        ...
        private compile( callback: (diagnostics:typescript.api.Diagnostic[]) => void ): void {
            ...
            if(!this.compiled) {
                ...
                if(!this.compiling) {
                    ...
                    this.compiler.compile(this.options.program, (result) => {
                        ...
                        that.compiler.dispose(); // dispose of worker.

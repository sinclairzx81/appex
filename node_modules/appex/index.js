                            ...
                            if (this.module.context.exports != null) {
                                if (this.module.attributes) {
                                    if (Object.prototype.toString.call(this.module.attributes) === '[object Array]') {
                                        for (var n in this.module.attributes) {
                                            var name = n;
                                            ...
                                            if (name == this.type.name) {
                                                ...
                                                if (accessor[name]) {
                                                    this._attribute = this.module.attributes[n];
        ...
        var Module = (function () {
            ...
            Module.prototype.load_context = function () {
                ...
                this.context = {
                    ...
                    exports: {},
                    module: {},
                    attribute: function (qualifier, data) {
                        if (data) {
                            _this.attributes[qualifier] = data;
                        } else {
                            return _this.attributes[qualifier];
                        }
                    }
                };
        ...
        var DevelopmentServer = (function () {
            ...
            DevelopmentServer.prototype.handler = function (request, response, next) {
                ...
                this.compile(function (diagnostics) {
                    ...
                    while (_this.waiters.length > 0) {
                        var waiter = _this.waiters.pop();
            ...
            DevelopmentServer.prototype.load_context = function (waiter) {
                var context = {};
...
(function (appex) {
    (function (web) {
        var Server = (function () {
            ...
            Server.prototype.load_context = function (waiter) {
                var context = {};

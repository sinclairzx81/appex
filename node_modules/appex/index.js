...
(function (appex) {
    (function (activation) {
        ...
        var Reflection = (function () {
            ...
            Reflection.prototype.locate = function (typename) {
...
(function (appex) {
    (function (activation) {
        var Runtime = (function () {
            ...
            Runtime.prototype.diagnostics = function (units) {
...
(function (appex) {
    (function (servicehost) {
        ...
        servicehost.Operation = Operation;
        ...
        var Meta = (function () {
            function Meta(activation) {
                ...
                activation.handles.forEach(function (handle) {
                    var service = _this.load_service(handle);
            ...
            Meta.prototype.load_service = function (handle) {
                var _this = this;
                ...
                if (type) {
                    ...
                    var typeref = type.typeinfo;

                    typeref.methods.forEach(function (method) {
                        var operation = _this.load_operation(method);
            ...
            Meta.prototype.load_operation = function (method) {
            ...
            Meta.prototype.resolve_type = function (typename) {
                var _this = this;
                ...
                if (typeinfo) {
                    ...
                    typeinfo.typeinfo.variables.forEach(function (variable) {
                        var field = new appex.servicehost.Field();

                        field.name = variable.name;

                        field.type = _this.resolve_type(variable.type.name);
    ...
    (function (servicehost) {
        var Host = (function () {
            ...
            Host.prototype.discovery_handler = function (request, response) {
                var json = JSON.stringify(this.meta, null, ' ');

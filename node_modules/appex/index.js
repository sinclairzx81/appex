    ...
    (function (modules) {
        ...
        var Module = (function () {
            ...
            Module.prototype.load_context = function () {
                this.context = {
                    __dirname: require("path").dirname(process.mainModule.filename),
                    __filename: require("path").join(require("path").dirname(process.mainModule.filename), "appex.module.js"),
                    global: global,
                    process: process,
                    require: require,
                    console: console,
            ...
            Module.prototype.load_class = function (_class) {
                if (_class.isExported) {
                    ...
                    _class.methods.forEach(function (obj) {
                        that.load_method(obj);
                    });

                    _class.variables.forEach(function (obj) {
                        that.load_variable(obj);
                    });
                }
            };
            ...
            DevelopmentServer.prototype.errors = function (diagnostics) {
                while (this.waiters.length > 0) {
                    ...
                    diagnostics.forEach(function (diagnostic) {
                        ...
                        if (that.options.logging) {
                            that.options.stderr.write(message.join(''));
                        }
                    });

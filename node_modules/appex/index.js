    ...
    (function (web) {
        (function (routing) {
            var ModuleGenericRoute = (function () {
                ...
                ModuleGenericRoute.prototype.handler = function (context, request, response, next) {
    ...
    (function (web) {
        (function (routing) {
            var ModuleIndexRoute = (function () {
                ...
                ModuleIndexRoute.prototype.handler = function (context, request, response, next) {
                    var accessor = this.moduleExport.accessor();
    ...
    (function (web) {
        (function (routing) {
            var ModuleJsonRoute = (function () {
                ...
                ModuleJsonRoute.prototype.handler = function (context, request, response, next) {
                    var _this = this;
                    var accessor = this.moduleExport.accessor();
    ...
    (function (web) {
        (function (routing) {
            var ModuleWildcardRoute = (function () {
                ...
                ModuleWildcardRoute.prototype.handler = function (context, request, response, next) {
                    var url = node.url.parse(request.url);
    ...
    (function (web) {
        (function (routing) {
            var ModuleRouter = (function () {
                ...
                ModuleRouter.prototype.handler = function (context, request, response, next) {
    ...
    (function (web) {
        var DevelopmentServer = (function () {
            ...
            DevelopmentServer.prototype.listen = function (port) {
                var _this = this;
                this.server = node.http.createServer(function (request, response, next) {
                    _this.handler(request, response, null);
                });
            ...
            DevelopmentServer.prototype.handler = function (request, response, next) {
                ...
                this.compile(function (diagnostics) {
                    ...
                    var context = _this.load_context(request, response);

                    while (_this.requests.length > 0) {
                        var pending = _this.requests.pop();

                        var handled = _this.router.handler(context, pending.request, pending.response, pending.next);
            ...
            DevelopmentServer.prototype.load_context = function (request, response) {
                var context = {};
            ...
            DevelopmentServer.prototype.compile = function (callback) {
                ...
                if (!this.compiling) {
                    ...
                    this.compiler.compile(this.options.sourcefile, function (result) {
                        ...
                        _this.module = new appex.modules.Module(result.javascript, result.reflection);
...
(function (appex) {
    (function (web) {
        var Server = (function () {
            ...
            Server.prototype.load_context = function (request, response) {
                var context = {};
...
function run(sourcefile, callback) {
    ...
    compiler.compile(sourcefile, function (result) {
        ...
        var module = new appex.modules.Module(result.javascript, result.reflection);

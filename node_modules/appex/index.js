            ...
            ModuleExport.prototype.cascade = function () {
                if (this._cascade_checked) {
                    ...
                    var lookup = function (qualifier) {
                        for (var n in that.module.cascades) {
                            if (n == qualifier) {
                                return that.module.cascades[n];
                            }
                        }
                    };
                    ...
                    if (this.module != null) {
                        if (this.module.context != null) {
                            if (this.module.context.exports != null) {
                                if (this.module.cascades) {
                                    if (Object.prototype.toString.call(this.module.cascades) === '[object Array]') {
                                        ...
                                        var global_cascade = lookup('');

                                        if (global_cascade) {
                                            this._cascade = global_cascade;
                                        }
                                        ...
                                        for (var n in scope) {
                                            ...
                                            if (accessor) {
                                                ...
                                                var cascade = lookup(qualifier_stack.join('.'));

                                                if (cascade) {
                                                    for (var n in cascade) {
                                                        this._cascade[n] = cascade[n];
                                                    }
                                                }
                                            } else {
                                                return {};
            ...
            Module.prototype.load_vm = function () {
                ...
                this.context = {
                    ...
                    cascade: function () {
                        ...
                        if (params.length == 1) {
                            that.cascades[''] = params[0];
                        }

                        if (params.length == 2) {
                            that.cascades[params[0]] = params[1];
                        }
                    }
                };
        ...
        (function (routing) {
            var IndexRoute = (function () {
                ...
                IndexRoute.prototype.handler = function (context) {
                    var target = this.moduleExport.accessor();
...
module.exports.cascade = function (qualifier, obj) {
};

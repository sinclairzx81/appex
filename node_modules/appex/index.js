...
(function (appex) {
    (function (web) {
        var ServerRequest = (function () {
            function ServerRequest(request, response, next) {
        ...
        web.ServerRequest = ServerRequest;
    })(appex.web || (appex.web = {}));
    var web = appex.web;
})(appex || (appex = {}));
                ...
                typescript.resolve([filename], function (resolved) {
                    ...
                    typescript.compile(resolved, function (compiled) {
                        ...
                        compiled.forEach(function (unit) {
                            ...
                            declaration.push(unit.declaration);
                ...
                if (this.module != null) {
                    if (this.module.context != null) {
                        if (this.module.context.exports != null) {
                            var reference = this.module.context.exports;
...
(function (appex) {
    (function (web) {
        (function (routing) {
            var ModuleGenericRoute = (function () {
                function ModuleGenericRoute(moduleExport) {
                    this.moduleExport = moduleExport;
                    this.initialize();
                }
                ModuleGenericRoute.prototype.match = function (request) {
                    var url = node.url.parse(request.url);

                    return this.pathname == url.pathname;
                };

                ModuleGenericRoute.prototype.handler = function (context, request, response) {
                ...
                ModuleGenericRoute.prototype.initialize = function () {
                ...
                return ModuleGenericRoute;
            })();
            routing.ModuleGenericRoute = ModuleGenericRoute;
        })(web.routing || (web.routing = {}));
        var routing = web.routing;
    })(appex.web || (appex.web = {}));
    var web = appex.web;
})(appex || (appex = {}));
//@ sourceMappingURL=ModuleGenericRoute.js.map
var appex;
(function (appex) {
    (function (web) {
        (function (routing) {
            var ModuleIndexRoute = (function () {
                function ModuleIndexRoute(moduleExport) {
                    this.moduleExport = moduleExport;
                    this.initialize();
                }
                ModuleIndexRoute.prototype.match = function (request) {
                    var url = node.url.parse(request.url);

                    return this.pathname == url.pathname;
                };

                ModuleIndexRoute.prototype.handler = function (context, request, response) {
                    var accessor = this.moduleExport.accessor();
                ...
                ModuleIndexRoute.prototype.initialize = function () {
                    var method = this.moduleExport.type;
                ...
                return ModuleIndexRoute;
            })();
            routing.ModuleIndexRoute = ModuleIndexRoute;
        })(web.routing || (web.routing = {}));
        var routing = web.routing;
    })(appex.web || (appex.web = {}));
    var web = appex.web;
})(appex || (appex = {}));
//@ sourceMappingURL=ModuleIndexRoute.js.map
var appex;
(function (appex) {
    (function (web) {
        (function (routing) {
            var ModuleJsonRoute = (function () {
                function ModuleJsonRoute(moduleExport) {
                    this.moduleExport = moduleExport;
                    this.initialize();
                }
                ModuleJsonRoute.prototype.match = function (request) {
                    var url = node.url.parse(request.url);

                    return this.pathname == url.pathname;
                };

                ModuleJsonRoute.prototype.handler = function (context, request, response) {
                    var _this = this;
                    var accessor = this.moduleExport.accessor();

                    if (accessor) {
                        this.read_request(request, function (input) {
                            accessor(context, input, function (output) {
                                _this.write_response(output, response);
                            });
                        });
                ...
                ModuleJsonRoute.prototype.read_request = function (request, callback) {
                    var buffer = [];
                ...
                ModuleJsonRoute.prototype.write_response = function (obj, response) {
                    try  {
                ...
                ModuleJsonRoute.prototype.initialize = function () {
                    var method = this.moduleExport.type;
                ...
                return ModuleJsonRoute;
            })();
            routing.ModuleJsonRoute = ModuleJsonRoute;
        })(web.routing || (web.routing = {}));
        var routing = web.routing;
    })(appex.web || (appex.web = {}));
    var web = appex.web;
})(appex || (appex = {}));
//@ sourceMappingURL=ModuleJsonRoute.js.map
var appex;
(function (appex) {
    (function (web) {
        (function (routing) {
            var ModuleWildcardRoute = (function () {
                function ModuleWildcardRoute(moduleExport) {
                    this.moduleExport = moduleExport;
                    this.initialize();
                }
                ModuleWildcardRoute.prototype.match = function (request) {
                    var url = node.url.parse(request.url);

                    return this.regexp.test(url.pathname);
                };

                ModuleWildcardRoute.prototype.handler = function (context, request, response) {
                    var url = node.url.parse(request.url);
                ...
                ModuleWildcardRoute.prototype.initialize = function () {
                    var method = this.moduleExport.type;
                ...
                ModuleWildcardRoute.prototype.arguments = function (url) {
                    var arguments = [];
                ...
                return ModuleWildcardRoute;
            })();
            routing.ModuleWildcardRoute = ModuleWildcardRoute;
        })(web.routing || (web.routing = {}));
        var routing = web.routing;
    })(appex.web || (appex.web = {}));
    var web = appex.web;
})(appex || (appex = {}));
//@ sourceMappingURL=ModuleWildcardRoute.js.map
    ...
    (function (web) {
        (function (routing) {
            var ModuleRouter = (function () {
                ...
                ModuleRouter.prototype.handler = function (context, request, response) {
                    for (var n in this.routes) {
                        var route = this.routes[n];

                        if (route.match(request)) {
                            return route.handler(context, request, response);
                        }
                    }
                ...
                ModuleRouter.prototype.initialize = function () {
                    ...
                    this.module.exports.forEach(function (moduleExport) {
                        if (moduleExport.type.identifier == 'method') {
                            var route = _this.resolve_route_from_export(moduleExport);
                ...
                ModuleRouter.prototype.validate_json_signature = function (method) {
                ...
                ModuleRouter.prototype.validate_generic_signature = function (method) {
                    if (method.parameters.length == 1) {
                        return true;
                    }
...
(function (appex) {
    (function (web) {
        var DevelopmentServer = (function () {
            ...
            DevelopmentServer.prototype.use = function (middleware) {
            ...
            DevelopmentServer.prototype.handler = function (request, response, next) {
                ...
                this.compile(function (diagnostics) {
                    if (diagnostics) {
                        _this.errors(diagnostics);

                        return;
                    }

                    while (_this.pending.length > 0) {
                        var waiter = _this.pending.pop();

                        var context = _this.load_context(waiter);

                        var handled = _this.router.handler(context, waiter.request, waiter.response);
            ...
            DevelopmentServer.prototype.load_context = function (request) {
                var context = {};
            ...
            DevelopmentServer.prototype.compile = function (callback) {
                ...
                if (!this.compiling) {
                    ...
                    this.compiler.compile(this.options.sourcefile, function (result) {
                        ...
                        _this.module = new appex.modules.Module(result);

                        _this.router = new appex.web.routing.ModuleRouter(_this.module);
        ...
        var Server = (function () {
            ...
            Server.prototype.handler = function (request, response, next) {
                ...
                this.compile(function (diagnostics) {
                    ...
                    while (_this.requests.length > 0) {
                        var pending = _this.requests.pop();

                        var context = _this.load_context(pending);

                        var handled = _this.router.handler(context, pending.request, pending.response);

                        if (handled) {
                            if (_this.options.logging) {
                                var message = [];

                                message.push(pending.request.method, ' ');

                                message.push('[', pending.stopwatch.stop().toString(), 'ms] ');

                                message.push(pending.request.url, '\n');
            ...
            Server.prototype.load_context = function (request) {
                var context = {};
...
module.exports.Worker = appex.Worker;
...
function run(sourcefile, callback) {
    var compiler = new appex.compiler.Compiler();

    compiler.compile(sourcefile, function (result) {
        compiler.dispose();

        if (result.diagnostics.length > 0) {
            result.diagnostics.forEach(function (diagnostic) {
                process.stdout.write(diagnostic.toString() + '\n');
            });

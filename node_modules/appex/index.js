...
(function (appex) {
    (function (web) {
        var Server = (function () {
            ...
            Server.prototype.handler = function (request, response, next) {
                ...
                this.compile(function (diagnostics) {
                    ...
                    while (that.waiters.length > 0) {
                        ...
                        var app_context = that.load_app_context(waiter);

                        var handled = that.router.handler(app_context, waiter.request, waiter.response);
            ...
            Server.prototype.load_app_context = function (waiter) {
                var app_context = new appex.web.app.App(this.server, waiter.request, waiter.response, waiter.next, this.module, this.router);

                app_context.mime = this.mime;

                for (var n in this.options.context) {
                    app_context[n] = this.options.context[n];
                }
    ...
    (function (web) {
        var Waiter = (function () {
            function Waiter(request, response, next) {
                ...
                this.next = next;
                this.stopwatch = new appex.timers.StopWatch();
    ...
    (function (web) {
        (function (app) {
            var Response = (function () {
                ...
                Response.prototype.serve = function () {
                    var params = [];
                    for (var _i = 0; _i < (arguments.length - 0); _i++) {
                        params[_i] = arguments[_i + 0];
                    }
                    ...
                    var _serve = function (status, path, filepath) {
                        ...
                        node.fs.stat(path, function (error, stats) {
                            if (error) {
                                not_found(filepath);
...
(function (appex) {
    (function (web) {
        (function (app) {
            var App = (function () {
                function App(server, serverRequest, serverResponse, next, module, router) {
                    this.server = server;

                    this.request = new appex.web.app.Request(serverRequest);

                    this.response = new appex.web.app.Response(serverResponse);
...
(function (appex) {
    (function (web) {
        var DevelopmentServer = (function () {
            ...
            DevelopmentServer.prototype.load_app_context = function (waiter) {
                var app_context = new appex.web.app.App(this.server, waiter.request, waiter.response, waiter.next, this.module, this.router);
    ...
    (function (web) {
        (function (routing) {
            var ModuleWildcardRoute = (function () {
                ...
                ModuleWildcardRoute.prototype.handler = function (app, request, response) {
...
(function (appex) {
    (function (web) {
        (function (routing) {
            var ModuleNamedRoute = (function () {
                function ModuleNamedRoute(moduleExport) {
                    this.moduleExport = moduleExport;
                    this.initialize();
                }
                ModuleNamedRoute.prototype.match = function (request) {
                    var url = node.url.parse(request.url);
                ...
                ModuleNamedRoute.prototype.handler = function (app, request, response) {
                    var accessor = this.moduleExport.accessor();
                ...
                ModuleNamedRoute.prototype.initialize = function () {
                    var method = this.moduleExport.type;
                ...
                return ModuleNamedRoute;
            })();
            routing.ModuleNamedRoute = ModuleNamedRoute;
        })(web.routing || (web.routing = {}));
        var routing = web.routing;
    })(appex.web || (appex.web = {}));
    var web = appex.web;
})(appex || (appex = {}));
//@ sourceMappingURL=ModuleNamedRoute.js.map
var appex;
(function (appex) {
    (function (web) {
        (function (routing) {
            var ModuleIndexRoute = (function () {
                ...
                ModuleIndexRoute.prototype.handler = function (app, request, response) {
                    var accessor = this.moduleExport.accessor();
    ...
    (function (web) {
        (function (routing) {
            var ModuleRouter = (function () {
                ...
                ModuleRouter.prototype.handler = function (app, request, response) {
...
module.exports.cascade = function (qualifier, data) {
};

...
declare module appex {
    class Runtime implements appex.IDisposable {
        ...
        private compiled;
        private compiling;
        constructor(options: appex.RuntimeOptions);
...
export declare function runtime(options: appex.RuntimeOptions): (request: http.ServerRequest, response: http.ServerResponse, next: () => void) => void;

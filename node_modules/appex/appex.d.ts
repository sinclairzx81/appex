...
declare module appex.web.routing {
    interface IRoute {
        ...
        handler(context: any, request: http.ServerRequest, response: http.ServerResponse): boolean;
    }
}
...
declare module appex.web {
    interface IHandler {
        (request: http.ServerRequest, response: http.ServerResponse, next?: Function): void;
    }
}
...
declare module appex.web {
    interface IServer {
        use(middleware: web.IHandler): void;

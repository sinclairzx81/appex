...
declare module appex {
    ...
    class HttpRuntime implements appex.IDisposable {
        private compiler;
        private module;
        private router;
...
export declare function runtime(options: appex.HttpRuntimeOptions): (request: http.ServerRequest, response: http.ServerResponse, next: () => void) => void;

...
declare module appex.schema {
    interface ISchema {
        reflection: appex.modules.Reflection;
        /** returns a json schema object for the given qualifier.
        *
        *   arguments:
        *       qualifier - fully qualified name of interface or class.
        */
        get(qualifier: string): any;
    }
}
...
declare module appex.schema {
    ...
    /** json schema api */
    class Schema implements schema.ISchema {
        ...
        *       returns        - the comment.
        */
        private load_description(reflected_type);
        ...
        */
        private is_qualified(qualified_name, qualified_names);
        ...
        */
        private load_qualified_typename(reflected_type);
        ...
        */
        private load_interface_variables(qualified_names, interface);
        ...
        */
        private load_schema_property_object(qualified_names, variable);
        /** loads a schema type
        *
        *   arguments:
        ...
        */
        private load_schema_object(qualified_names, interface);
        /** safely loads a reflected type.
        *
        */
        private load_reflected_type(qualified_names, reflection_type);
        /**
        *
        *   arguments:
...
declare module appex.web {
    class Context implements web.IContext {
        ...
        public module: appex.modules.IModule;
        /** the appex schema api */
        public schema: appex.schema.ISchema;
        /** mime utility */

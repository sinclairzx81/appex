...
(function (TypeScript) {
    (function (Api) {
        var CompiledUnit = (function (_super) {
            ...
            function CompiledUnit(path, content, diagnostics, ast, sourcemap, script, references) {
                _super.call(this, path, content, diagnostics);
...
(function (TypeScript) {
    (function (Api) {
        ...
        Api.CompilerOptions = CompilerOptions;
    })(TypeScript.Api || (TypeScript.Api = {}));
    var Api = TypeScript.Api;
})(TypeScript || (TypeScript = {}));
var TypeScript;
(function (TypeScript) {
    (function (Api) {
        var CompilerCache = (function () {
            ...
            CompilerCache.prototype.get_cached_unit = function (path) {
            ...
            CompilerCache.prototype.is_in_cache = function (path) {
                for (var i = 0; i < this.units.length; i++) {
                    if (this.units[i].path == path) {
                        return true;
                    }
            ...
            CompilerCache.prototype.compare = function (a, b) {
            ...
            CompilerCache.prototype.refresh = function (units) {
                for (var i = 0; i < units.length; i++) {
                    if (units[i].diagnostics.length == 0) {
                        if (this.is_in_cache(units[i].path) == false) {
                            ...
                            this.compiler.addSourceUnit(new_unit.path, snapshot, 1, 0, false, references);
                            ...
                            if (this.compare(units[i], cached_unit) == false) {
                                var updated_unit = units[i];

                                var snapshot = TypeScript.ScriptSnapshot.fromString(updated_unit.content);
            ...
            CompilerCache.prototype.syntaxCheck = function (unit) {
                var diagnostics = [];
            ...
            CompilerCache.prototype.typeCheck = function (unit) {
                var diagnostics = [];
            ...
            CompilerCache.prototype.type_and_syntax_checking = function () {
                for (var i = 0; i < this.units.length; i++) {
            ...
            CompilerCache.prototype.update = function (units) {
                this.refresh(units);

                this.type_and_syntax_checking();
            };

            CompilerCache.prototype.reevaluate_references = function () {
        ...
        Api.CompilerCache = CompilerCache;
    })(TypeScript.Api || (TypeScript.Api = {}));
    var Api = TypeScript.Api;
})(TypeScript || (TypeScript = {}));
var TypeScript;
...
(function (TypeScript) {
    (function (Api) {
        ...
        var CompilerEmitter = (function () {
            function CompilerEmitter(compiler, cache) {
                this.compiler = compiler;
                this.cache = cache;
                this.emitter = new Emitter();
            }
            CompilerEmitter.prototype.get_content = function (unit) {
            ...
            CompilerEmitter.prototype.get_declararion = function (unit) {
            ...
            CompilerEmitter.prototype.get_source_map = function (unit) {
            ...
            CompilerEmitter.prototype.get_reflection = function (unit, ast) {
                var _script = TypeScript.Api.Script.create(unit.path, ast);

                return _script;
            };

            CompilerEmitter.prototype.emit = function () {
                this.emitter = new TypeScript.Api.Emitter();

                var emitter_io_map = [];

                this.compiler.emitAll(this.emitter, function (inputFile, outputFile) {
            ...
            return CompilerEmitter;
        })();
        Api.CompilerEmitter = CompilerEmitter;
    })(TypeScript.Api || (TypeScript.Api = {}));
    var Api = TypeScript.Api;
})(TypeScript || (TypeScript = {}));
var TypeScript;
    ...
    (function (Api) {
        var Compiler = (function () {
            ...
            Compiler.prototype.compile = function (sourceUnits, callback) {
                if (this.passes == 0) {
                    this.cache.update(sourceUnits.map(function (unit) {
                        return unit.clone();
                    }));

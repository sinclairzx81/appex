...
(function (TypeScript) {
    (function (Api) {
        (function (Reflect) {
            ...
            Reflect.ReflectedType = ReflectedType;
...
(function (TypeScript) {
    (function (Api) {
        (function (Reflect) {
            ...
            Reflect.TypeResolver = TypeResolver;
        })(Api.Reflect || (Api.Reflect = {}));
        var Reflect = Api.Reflect;
    })(TypeScript.Api || (TypeScript.Api = {}));
    var Api = TypeScript.Api;
...
(function (TypeScript) {
    (function (Api) {
        (function (Compile) {
            ...
            Compile.CompilerOptions = CompilerOptions;
            ...
            var Compiler = (function () {
                ...
                Compiler.prototype.compile_pass = function (sourceUnits, callback) {
                ...
                Compiler.prototype.compile = function (sourceUnits, callback) {
                    ...
                    if (this.passes == 0) {
                        ...
                        this.compile_pass(sourceUnits, function () {
                            sourceUnits.reverse();

                            _this.compile_pass(sourceUnits, function (compiledUnits) {
                    ...
                    this.compile_pass(sourceUnits, function (compiledUnits) {
                        compiledUnits.reverse();
